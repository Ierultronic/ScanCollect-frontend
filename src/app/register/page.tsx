    ...
    <main className="min-h-screen flex items-center justify-center relative">
      <div className="bg-white/90 backdrop-blur-md rounded-2xl p-8 shadow-2xl border border-purple-200/50 max-w-md w-full mx-4 relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Create your account and start collecting</p>
        </div>
        ...
        <form className="space-y-6">
          ...
          <Button className="w-full bg-gradient-to-r from-green-500 to-yellow-500 hover:from-green-600 hover:to-yellow-600 text-white border-0 shadow-lg">
            Create Account
          </Button>
        </form>
